...
function getDirectionAwareKey(key: string, dir?: Direction) {
    ...
    const reversedKey = key === 'ArrowRight' ? 'ArrowLeft' : key;
    return key === 'ArrowLeft' ? 'ArrowRight' : reversedKey;
}
...
function ActionBar(props: Readonly<ActionBarProps>) {
    const {
        open = false,
        onOpenChange,
        onEscapeKeyDown,
...
function ActionBarSelection(props: Readonly<DivProps>) {
...
function ActionBarGroup(props: Readonly<DivProps>) {
    const {
        onBlur: onBlurProp,
        onFocus: onFocusProp,
...
function ActionBarItem(props: Readonly<ActionBarItemProps>) {
    const {
        onSelect,
        onClick: onClickProp,
        onFocus: onFocusProp,
...
function ActionBarClose(props: Readonly<ActionBarCloseProps>) {
...
interface ActionBarSeparatorProps extends Readonly<DivProps> {
    orientation?: Orientation;
}

function ActionBarSeparator(props: Readonly<ActionBarSeparatorProps>) {
