        ...
        <ThemeProvider initialTheme={theme}>
            <TooltipProvider>
                <SidebarProvider defaultOpen={sidebarOpen}>
                    ...
                    <SidebarInset>
                        <header className="flex h-16 shrink-0 items-center gap-2 shadow transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
