...
function NumberField({
    ...
    const fieldContextValues = useMemo(() => ({ fieldId, size: sizeValue }), [fieldId, sizeValue]);

    return (
        <NumberFieldContext.Provider value={fieldContextValues}>
...
function NumberFieldDecrement({
    ...
    return (
        <NumberFieldPrimitive.Decrement
            className={cn(numberFieldButtonVariants({ size }), 'rounded-s-md border-e-0', className)}
...
function NumberFieldIncrement({
    ...
    return (
        <NumberFieldPrimitive.Increment
            className={cn(numberFieldButtonVariants({ size }), 'rounded-e-md border-s-0', className)}
...
function CursorGrowIcon(props: Readonly<React.ComponentProps<'svg'>>) {
    return (
        <svg
            fill="black"
            height="14"
