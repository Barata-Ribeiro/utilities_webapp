    ...
    return (
        <Card className="w-full max-w-sm">
            ...
            <CardContent className="grid gap-4">
                <Field data-invalid={value === '-' || percentOf === '-'}>
                    <FieldLabel htmlFor={valueId}>(X) is</FieldLabel>
                    <Input
                        id={valueId}
                        name="value"
                        placeholder="e.g. 50"
                ...
                <Field data-invalid={percentOf === '-'}>
                    <FieldLabel htmlFor={percentOfId}>p% of what?</FieldLabel>
                    <Input
                        id={percentOfId}
                        name="percentOf"
                        inputMode="decimal"
