    ...
    function handleCalculation(event: ChangeEvent<HTMLInputElement>) {
        ...
        switch (name) {
            ...
            case 'ofValue': {
                ...
                if (Number.isNaN(percentNum) || num === 0) {
                    setResult(null);
                    return;
                }
        ...
        <Card className="w-full max-w-sm">
            ...
            <CardContent className="grid gap-4">
                <Field data-invalid={percentValue === '-'}>
                    <FieldLabel htmlFor={percentValueId}>(X) is what percent</FieldLabel>
                    <Input
                        id={percentValueId}
                        name="percentValue"
                        placeholder="e.g. 60"
                ...
                <Field data-invalid={ofValue === '-'}>
                    <FieldLabel htmlFor={ofValueId}>Of (Y)</FieldLabel>
                    <Input
                        id={ofValueId}
                        name="ofValue"
                        inputMode="decimal"
                ...
                <Field>
                    <FieldLabel htmlFor={resultId}>Result (p)</FieldLabel>
                    <Input
                        id={resultId}
                        name="result"
                        placeholder="Result"
