            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <section className="mt-4">
                    ...
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                        ...
                        <li>
                            <strong>Kilobytes (KB)</strong>: A unit of data equal to 1,024 bytes, commonly used for
                            small files.
                        </li>
                        <li>
                            <strong>Megabytes (MB)</strong>: A unit of data equal to 1,024 kilobytes, often used for
                        ...
                        <li>
                            <strong>Petabytes (PB)</strong>: A unit of data equal to 1,024 terabytes, used for
                            large-scale data storage and cloud services.
                        </li>
                    </ul>
                </section>
                ...
                <footer className="text-xs text-muted-foreground">
                    Tip: Use this converter to quickly switch between different data size units for better file
                    management and understanding of digital storage. This utility runs locally in your browser and does
                    not transmit any data to a server.
                </footer>
            </article>
        </>
    );
