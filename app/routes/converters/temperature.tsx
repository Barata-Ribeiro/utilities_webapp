        ...
        <>
            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                    Easily convert temperatures between Celsius, Fahrenheit, and Kelvin. Perfect for cooking, science,
                    and everyday use.
                </p>
                ...
                <section className="mt-4">
                    ...
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                        ...
                        <li>
                            <strong>Fahrenheit (°F)</strong>: The imperial unit of temperature, primarily used in the
                            United States.
                        </li>
                        <li>
