            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <section className="mt-4">
                    ...
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                        <li>
                            <strong>Nanoseconds (ns)</strong>: A unit of time equal to one billionth of a second,
                        ...
                        <li>
                            <strong>Seconds (s)</strong>: The base unit of time in the International System of Units
                            (SI), commonly used for short durations.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Hours (h)</strong>: A unit of time equal to 60 minutes or 3600 seconds, widely used
                            in daily life and work schedules.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Months (mo)</strong>: A unit of time based on the lunar cycle, typically ranging
                            from 28 to 31 days, used in calendars and for scheduling.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Decades (dec)</strong>: A unit of time equal to 10 years, often used in historical
                            and scientific contexts.
                        </li>
                        <li>
                            <strong>Centuries (cen)</strong>: A unit of time equal to 100 years, commonly used in
                            historical contexts to describe long periods.
                        </li>
                    </ul>
                </section>
