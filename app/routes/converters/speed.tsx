            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <section className="mt-4">
                    ...
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                        ...
                        <li>
                            <strong>Miles per hour (mph)</strong>: An imperial unit of speed primarily used in the
                            United States and the UK for road traffic.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Feet per second (ft/s)</strong>: An imperial unit of speed sometimes used in the US
                        ...
                        <li>
                            <strong>Mach (Ma)</strong>: A dimensionless unit representing the ratio of an object&#39;s
                            speed to the speed of sound in the surrounding medium, often used in aviation and aerospace.
                        </li>
                    </ul>
                </section>
                ...
                <footer className="text-xs text-muted-foreground">
                    Tip: Use the speed converter to quickly switch between different speed units. This tool is perfect
                    for converting speeds when planning trips, tracking athletic performance, or understanding vehicle
                    speeds in various contexts. This utility runs locally in your browser and does not transmit any data
                    to a server.
                </footer>
            </article>
        </>
