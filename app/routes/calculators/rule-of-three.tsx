...
export const METADATA: Metadata = {
    ...
    keywords: ['rule of three', 'proportion', 'calculator', 'math', 'ratio', 'utilities'],
};
        ...
        <>
            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                    Calculate the fourth term in a proportion using the Rule of Three. This tool helps you find an
                    unknown value when you know three other values that are in proportion.
                </p>
                ...
                <section className="mt-4">
                    ...
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                        ...
                        <li>
                            <strong>Calculate the fourth term (D)</strong>: The calculator will compute the unknown
                            value using the formula: D = (B * C) / A.
                        </li>
                    </ul>
                </section>
