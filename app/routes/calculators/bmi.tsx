        ...
        <>
            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                    Calculate your Body Mass Index (BMI) to assess your body weight relative to your height. This tool
                    helps you understand whether you&#39;re underweight, normal weight, overweight, or obese based on
