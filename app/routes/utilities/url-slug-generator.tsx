        ...
        <>
            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                    Create SEO-friendly URL slugs from your titles or phrases. Customize the format and style to suit
                    your needs.
                </p>
                ...
                <footer className="mt-4 text-xs text-muted-foreground">
                    Tip: Use the generated slugs to improve your website&#39;s SEO and make your URLs more
                    user-friendly. This utility runs locally in your browser and does not transmit any data to a server.
                </footer>
            </article>
        </>
    );
