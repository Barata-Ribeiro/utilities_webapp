            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <section className="mt-4">
                    ...
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                        ...
                        <li>
                            <strong>Download</strong>: Click the generate button to create your QR code and download it
                            as an image file.
                        </li>
                        <li>
                ...
                <footer className="mt-4 text-xs text-muted-foreground">
                    Tip: Use the generated QR codes to share links quickly and conveniently. This utility runs locally
                    in your browser and does not transmit any data to a server.
                </footer>
            </article>
        </>
    );
