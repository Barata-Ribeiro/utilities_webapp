...
import LoremIpsumGenerator from '~/components/pages/utilities/lorem-ipsum';
        ...
        <>
            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                    Generate placeholder text for your designs and layouts. Customize the number of paragraphs, words,
                    or sentences to fit your needs.
                </p>
