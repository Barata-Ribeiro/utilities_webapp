        ...
        <>
            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                    Quickly convert images to Base64 format online. Upload your image and get the Base64 encoded string
                    for easy embedding in HTML, CSS, or JSON.
                </p>
                ...
                <section className="mt-4">
                    ...
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                        ...
                        <li>
                            <strong>Convert</strong>: The tool will process the image and generate a Base64 encoded
                            string.
                        </li>
                        <li>
                ...
                <footer className="text-xs text-muted-foreground">
                    Tip: Large images may take longer to convert. For best results, use images under 1MB. This utility
                    runs locally in your browser and does not transmit your images to any server.
                </footer>
            </article>
        </>
    );
