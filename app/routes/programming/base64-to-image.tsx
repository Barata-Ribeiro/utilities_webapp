        ...
        <>
            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                    Easily convert Base64 encoded strings back to images online. Paste your Base64 string and download
                    the decoded image in various formats.
                </p>
                ...
                <section className="mt-4">
                    ...
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                        <li>
                            <strong>Paste Base64 String</strong>: Input your Base64 encoded string into the provided
                            field.
                        </li>
                        <li>
                            <strong>Convert</strong>: The tool will decode the Base64 string and generate the
                            corresponding image.
                        </li>
                        <li>
                            <strong>Download & Use</strong>: Download the decoded image in your preferred format for use
                            in your projects.
                        </li>
                    </ul>
                </section>
