            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <section className="mt-4">
                    ...
                    <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
                        <li>
                            <strong>Paste Text</strong>: Input your plain text or Base64 encoded string into the
                            provided field.
                        </li>
                        <li>
                            <strong>Encode/Decode</strong>: Choose to either encode the plain text to Base64 or decode
                            the Base64 string back to plain text.
                        </li>
                        <li>
                            <strong>Copy & Use</strong>: Copy the resulting text for use in your projects or
                            communications.
                        </li>
                    </ul>
                </section>
