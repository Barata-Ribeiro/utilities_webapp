...
export const METADATA: Metadata = {
    ...
    description: 'Learn more about the Utilities web app, its features, and how to contribute.',
    keywords: ['utilities', 'web tools', 'about', 'project overview', 'contributing'],
};
            ...
            <article className="rounded-md bg-card p-6 shadow">
                ...
                <section className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-3">
                        ...
                        <p className="text-sm text-muted-foreground">
                            This project groups short, useful web utilities into a single, fast interface. Each tool
                            runs client-side where possible so user data stays in the browser. The app is intentionally
                            small and composable so features can be reused across tools.
                        </p>
                ...
                <section className="mt-6">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        ...
                        accessible building blocks, and small client/server actions for optional functionality (examples
                        in <code className="rounded bg-muted px-1 py-0.5 text-xs">app/routes</code>).
                    </p>

                    <ul className="mt-2 list-inside list-disc text-sm text-muted-foreground">
                        <li>Client-first pages and components where appropriate.</li>
                        <li>
                            Server actions used sparingly for things like setting up cookies and handling some logic.
                        </li>
                        <li>
                            Organized routes under{' '}
                ...
                <section className="mt-6">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        Contributions are welcome. If you would like to contribute, pick one of the small utilities or
                        file an issue to discuss bigger changes.
                    </p>
