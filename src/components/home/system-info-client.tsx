        ...
        <div aria-busy={isPending} className="bg-card rounded-md p-6 shadow">
            ...
            <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-3">
                <div className="rounded-md border p-3">
                    <h3 className="text-muted-foreground text-xs font-medium">IP Address</h3>
                    <div className="mt-1 text-sm">
                        {isPending && ipAddress === null ? <Skeleton className="h-5 w-28" /> : <span>{ipAddress}</span>}
                    </div>
                </div>
                <div className="rounded-md border p-3">
                    <h3 className="text-muted-foreground text-xs font-medium">Browser</h3>
                    <div className="mt-1 text-sm">
                        {isPending && browser === null ? <Skeleton className="h-5 w-40" /> : <span>{browser}</span>}
                    </div>
                </div>
                <div className="rounded-md border p-3">
                    <h3 className="text-muted-foreground text-xs font-medium">Operating System</h3>
                    <div className="mt-1 text-sm">
